	...
	\tikzstyle{block} = [rectangle, draw, text width=10em, text centered, rounded      corners, minimum height=3em]
		...
		%/pgf/arrow keys/length=2mm
			...
			\begin{tikzpicture}
				...
				\node (gamename) at (745pt,-40pt) [,draw = NameBlockBorderColor, fill = NameBlockFillColor,text=NameBlockFontColor, minimum width=380pt,minimum height=100pt,line width=3pt] {\textbf{$A\pi o \lambda\lambda\omega\upsilon$}};
				...
				{
					Moving spacecrafts in its orbit. Bounce and elminate the protons.};
				\draw [-stealth, line width=2pt] (gameplayhighlight.east)-- ++(50pt,0pt) 
				node[right, GCBlocksStyle,minimum height = 60pt, minimum width = 300pt, text width = 290pt] 
				{
					Move spacecrafts. Avoid the proton from either escaping or colliding with earth. };
				\draw [-stealth, line width=2pt] (gameplaytrend.east)-- ++(50pt,0pt) 
				node[right, GCBlocksStyle,minimum height = 60pt, minimum width = 300pt, text width = 290pt] 
				{
					More proton will occur. Meanwhile, earth will be more difficult to protect.};
				\draw [-stealth, line width=2pt] (gameplayreward.east)-- ++(50pt,0pt) 
				node[right, GCBlocksStyle,minimum height = 60pt, minimum width = 300pt, text width = 290pt] 
				{
					Sense of honor because of protecting the galaxy. More spacecrafts available.};
				...
				node[left, GCBlocksStyle,minimum height = 150pt, minimum width = 370pt, text width = 360pt] 
				{
					Tragically, player will not succeed but only seize higher score in the endless model. However, their courage and wisdom remain in history--that's the dignity of humankind.};
				...
				node[above, GCBlocksStyle,minimum height = 90pt, minimum width = 520pt, text width = 510pt] 
				{
					Being a cosmic solider to operate spacecrafts to prevent the solar protons from escaping into the galaxy and protect the solar system and the Earth. Free to bounce or carry the proton.};
